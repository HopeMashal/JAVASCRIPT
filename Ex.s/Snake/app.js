document.addEventListener('DOMContentLoaded', () => {
  ...
  function moveOutcomes() {
    ...
    if (
      ...
      return clearInterval(interval),alert('Game Over'),window.location.reload() //this will clear the interval if any of the above happen
    }
  ...
  function control(e) {
    squares[currentIndex].classList.remove('food')
