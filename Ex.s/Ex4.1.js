...
if (numSiblings === 1) {
  console.log('1 sibling!');
    ...
    console.log('No siblings')
// when the prompt-input=1, the first if statement becomes false so the else statement is applied
} 
...
if (numSiblings === 1) {
  console.log('1 sibling!');
    ...
    console.log('No siblings')
// when the number-input=1, the first if statement becomes true
// === operator becomes true when the types of the two elements is the same
}
